...
coarse_model_and_render = dict(
    num_voxels=150000,           # expected number of voxel default: 1024000
    num_voxels_base=150000,      # to rescale delta distance default: 1024000
...
fine_model_and_render.update(dict(
    num_voxels=60**3, # default 160
    num_voxels_base=60**3, # default 160
    rgbnet_dim=12,
    alpha_init=1e-2,
